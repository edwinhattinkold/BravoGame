...
Sound::Sound(){
	...
	sounds->insert( std::pair<int, std::string>( Sound_Shooting_Machine_Gun,	"Shooting/machine_gun.wav" ) );
	sounds->insert( std::pair<int, std::string>( Sound_Explosion,				"explosion.wav" ) );
}
